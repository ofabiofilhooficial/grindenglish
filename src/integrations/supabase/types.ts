...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      become_teacher: { Args: never; Returns: boolean }
      fix_all_words_learned_counters: {
        Args: never
        Returns: {
          new_count: number
          old_count: number
      ...
      grant_teacher_role: { Args: { _user_id: string }; Returns: boolean }
      has_role: {
        Args: {
      ...
      recalculate_words_learned: { Args: { _user_id: string }; Returns: number }
