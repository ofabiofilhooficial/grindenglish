    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-secondary/30 px-4 py-12">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-2xl font-bold uppercase tracking-wide">Create your account</h1>
        ...
        <Card className="border-border/50 shadow-xl">
          <CardContent className="pt-6">
            ...
            <Button variant="outline" className="w-full h-11 gap-2" onClick={async () => {
